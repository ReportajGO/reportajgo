...
const I18N = {
  en: {
    ...
    contentLangs: "Content languages", contentLangsHelp: "Every post is written in the FIRST selected language. Markets change the framing, never the language.",
  ...
  uz: {
    ...
    contentLangs: "Kontent tillari", contentLangsHelp: "Har bir post BIRINCHI tanlangan tilda yoziladi. Bozorlar faqat qamrovni belgilaydi, tilni emas.",
  ...
  ru: {
    ...
    contentLangs: "Языки контента", contentLangsHelp: "Каждый пост пишется на ПЕРВОМ выбранном языке. Рынки меняют подачу, но не язык.",
